...
(function () {
  ...
  window.api = {
    ...
    events: {
      onProgress: (h) => { (window.__progressHandlers = window.__progressHandlers || []).push(h); }, onGameLog: () => {}, onGameStarted: () => {}, onGameExit: () => {},
    ...
    accounts: { list: () => delay({ list: [{ id: 'a1', name: 'Steve', type: 'offline' }], activeId: 'a1' }) },
    instances: {
    ...
    friends: { status: () => delay({ code: 'KB-1234', friends: [] }) },
    ...
    account: {
      status: () => delay({ signedIn: true, online: true, configured: true, user: { username: 'Steve', uuid: '5627dd98-e6be-3c21-b8a8-e92344183641' }, offlineDaysLeft: 30 }),
      restore: () => delay({ signedIn: true, online: false, configured: true, user: { username: 'Steve', uuid: '5627dd98-e6be-3c21-b8a8-e92344183641' }, offlineDaysLeft: 12 }),
      register: () => delay({ signedIn: true, online: true, configured: true, user: { username: 'Steve' }, offlineDaysLeft: 30 }),
      login: () => delay({ signedIn: true, online: true, configured: true, user: { username: 'Steve' }, offlineDaysLeft: 30 }),
      logout: () => delay({ signedIn: false, online: false, configured: true, user: null }),
      changePassword: () => delay({ signedIn: true, online: true, configured: true, user: { username: 'Steve' }, offlineDaysLeft: 30 }),
